  ...
  <nav class="bg-gray-800">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/notification" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Notification</a>
              <a href="/messaging" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Messaging</a>
            </div>
          </div>
        </div>
    ...
    <div class="md:hidden hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="/notification" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Notification</a>
        <a href="/messaging" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Messaging</a>
...
<script>
  ...
  function handleLoginClick() {
    // For demonstration, we use alert. In a real-world scenario, you'd redirect to a login page or show a login form.
    alert('Login');
  }
</script>
</body>
